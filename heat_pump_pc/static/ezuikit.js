...
(function (global, factory) {
    ...
    http_request.onreadystatechange = function () {
      if (http_request.readyState === 4) {
        if (http_request.status === 200) {
          var _data = http_request.responseText
          success(_data)
        }
      }
    }
  ...
  EZUIPlayer.prototype.initCKPlayer = function (url) {
    ...
    this.video = document.getElementById('playWind')
  ...
  EZUIPlayer.prototype.initDecoder = function (playParams) {
    ...
    function initDecoder(resolve, reject) {
      var jsPluginPath = playParams.decoderPath + '/static/jsPlugin-1.2.0.min.js'
      ...
      addJs(jsPluginPath, function () {
        ...
        _this.jSPlugin = new JSPlugin({
          ...
          szBasePath: playParams.decoderPath + '/static/'
        })
        _this.log('初始化解码器----完成')
        _this.log('开始设置秘钥')
