...
(function (global, factory) {
  ...
  !function (a, b) {
    ...
    function i (a, b) {
      ...
      }, a.createDocumentFragment = Function('h,f', 'return function(){var n=f.cloneNode(),c=n.createElementh.shivMethods&&(' + d().join().replace(/[\w\-:]+/g, function (a) {
    ...
    function j (a) {
      a || (a = b)
      var d = f(a)
      return !t.shivCSS || k || d.hasCSS || (d.hasCSS = !!c(a, 'article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0color:#000}template{display:none}')), l || i(a, d), a
    }
