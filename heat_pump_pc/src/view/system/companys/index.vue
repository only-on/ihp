  ...
  <div class="body">
    <div class="body-top">
      <Button @click="add" type="text" style="color:#82C225;">
        ...
        <span style="margin-right: 20px;font-size: 20px;color: #82C225">新增分公司</span>
      </Button>
      <Input  v-model="param.keyword" icon="ios-close-circle" @on-click="backKeyword" placeholder="输入名称/地址搜索" style="width: 300px; float: right;margin-right: 20px;" @on-change="keywordChange()">
      </Input>
    </div>
    <div class="head">
      <Row>
        ...
        <div class="head-title">
          ...
          <span style="margin-right: 20px;font-size: 16px;color: #666666">分公司管理</span>
        </div>
        </Col>
      </Row>
    </div>
...
<script>
import { getCompanyList, delCompany } from '../../../api/api'
export default {
  data () {
    return {
      reviewForm: {},
  ...
  methods: {
    ...
    // 编辑
    edit (index) {
      this.$router.push({name: 'company_edit', params: {id: index, param: this.param}})
    },
    remove (id) {
      // console.log(id)
      var th = this
