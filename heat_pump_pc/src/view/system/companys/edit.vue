    ...
    <div class="head">
      <Row>
        ...
        <div class="head-title">
          ...
          <span style="margin-right: 20px;font-size: 16px;color: #666666">编辑分公司</span>
        </div>
        </Col>
      </Row>
    </div>
...
<script>
import { companyDetail, editCompany } from '../../../api/api'
      ...
      if (this.submitVal()) {
        ...
        editCompany(para).then((res) => {
          if (res.data.code === 1000) {
            this.$router.push({name: 'companys_manage', params: {param: this.$route.params.param}})
            this.$Message.success('分公司修改成功！')
          } else {
